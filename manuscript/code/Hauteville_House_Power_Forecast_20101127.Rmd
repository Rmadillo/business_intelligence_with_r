---
title: "Six Month Electricty Use Forecast: Nov 2010-Apr 2011"
...
dyEvent(date = "2008-08-01", "Closed for vacation", labelLoc = "top") %>%
...
```{r forecasttable, echo=FALSE, warning=FALSE, message=FALSE, results='asis'}
kable(total_use_fc)
```
...
Dimensions: 2,075,259 observations of 13 variables
...
```{r missingplot, echo=FALSE, warning=FALSE, message=FALSE}
...
```{r missingvalues, echo=FALSE, warning=FALSE, message=FALSE}
...
```{r monthlyuse, echo=FALSE, warning=FALSE, message=FALSE}
...
Dimensions: 56 observations of 7 variables
...
```{r basic_fc_plot, echo=FALSE, warning=FALSE, message=FALSE}
# View model summary
...
***R Session Info***  
Code location/File name: `Hauteville_House_Power_Forecast_20101127.Rmd`  

This file compiled `r Sys.time()`.  
`r sessionInfo()`  
